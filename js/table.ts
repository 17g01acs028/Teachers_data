document.addEventListener("DOMContentLoaded", function (event) {
    ...
    const drawer_btn = document.querySelector(".drawer_btn") as HTMLButtonElement;
    ...
    const columnSelect = document.querySelector('select[name="column"]') as HTMLSelectElement;
    ...
    `;
        ...
        const columnSelect = newRow.querySelector('select[name="column"]') as HTMLSelectElement;
        columnSelect.addEventListener('change', function () {
    ...
    // Add event listener to the submit button
    const canceBtn = document.getElementById('cancelBtn') as HTMLButtonElement;
    ...
    const clearBtn = document.getElementById('clear_ad_filter') as HTMLButtonElement;
    clearBtn.addEventListener('click', function () {
        const sinput =  document.getElementById("second_input_field") as HTMLInputElement
    ...
    table.addEventListener('input', (event:any) => {
    ...
    var pageElement = document.getElementById("page") as HTMLLabelElement;
    var pagesElement = document.getElementById("pages") as HTMLLabelElement;
    ...
    var pageCount = document.getElementById("pageCount") as HTMLSelectElement;
